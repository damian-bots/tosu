...
def cookie_txt_file() -> str:
    ...
    if not txt_files:
        return "cookies/cookies.txt" # Safe fallback
...
class YouTubeAPI:
    ...
    async def download(
        ...
        # We put this at the very top so both /play 
        # and /song commands benefit from the API!
        # ============================================
        ...
        try:
            ...
            if optimized_path and os.path.exists(optimized_path):
                if songvideo or songaudio:
                    return optimized_path  # /song expects string
                return optimized_path, True  # /play expects tuple
