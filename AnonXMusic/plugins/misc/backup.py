...
from AnonXMusic.core.dir import BACKUP_DIR
...
async def manual_backup(_: Client, message: Message):
    processing = await message.reply_text(
        "<emoji id='5456327427795982532'>🪶</emoji> <b>Starting Backup…</b>\n"
...
async def restore_backup(_: Client, message: Message):
    ...
    try:
        ...
        await processing.edit_text(
            f"<emoji id='5210952531676504517'>❌</emoji> <b>Restore Failed!</b>\n<b>Error:</b> <code>{e}</code>"
        )
